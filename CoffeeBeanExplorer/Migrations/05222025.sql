...
(
    ...
    CONSTRAINT "IX_Origins_Country_Region" UNIQUE ("Country", "Region")
);
...
(
    ...
    "Name"      VARCHAR(100) NOT NULL,
    "CreatedAt" TIMESTAMP    NOT NULL DEFAULT now(),
    CONSTRAINT "UX_Lists_UserId_Name" UNIQUE ("UserId", "Name")
);
